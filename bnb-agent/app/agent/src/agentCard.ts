...
const NEGOTIATE: AgentSkill = {
  id: "negotiate",
  name: "Purchase an AfterBell continuity inspection",
  description:
    'Send a data part with {"skill":"negotiate","task_description":<WatchedPosition JSON>,' +
    '"terms":{"deliverables":"afterbell-watchtower-result/1 JSON","quality_standards":"deterministic fail-closed policy"}} and receive a ' +
  ...
  tags: ["erc8183", "tokenized-stocks", "risk", "bnb-chain"],
...
export function buildAgentCard(
  ...
  return {
    name,
    description: `AfterBell tokenized-stock continuity Watchtower (${name}) — deterministic paid inspections over ERC-8183 and X402.`,
