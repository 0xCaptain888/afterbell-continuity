...
// ── Deterministic AfterBell delivery hook ────────────────────────────────────
// Paid work is a structured continuity inspection, not a free-form LLM task.
// The commerce runtime still owns bounded quote/delivery signing, while this
// hook parses the buyer's JSON position and returns a reproducible policy
// decision. No wallet key, raw signer, or transaction method is exposed here.
